	...
	WifiManager wifiManager=null;    
	     ...
	     {    
			...
			public void onClick(View v) {
				...
				wifiManager=(WifiManager)MoreWifiSettingPage.this.getSystemService(Context.WIFI_SERVICE);    
	             ...
	             Toast.makeText(MoreWifiSettingPage.this, "当前WiFi状态为：开"/*+wifiManager.getWifiState()*/, Toast.LENGTH_SHORT).show();    
	     ...
	     {    
	         ...
	         public void onClick(View v) {    
	             ...
	             System.out.println("wifi state --->"+wifiManager.getWifiState());    
	             Toast.makeText(MoreWifiSettingPage.this, "当前WiFi状态为：关"/*+wifiManager.getWifiState()*/, Toast.LENGTH_SHORT).show();    
	         }    
	     ...
	     {    
	         ...
	         public void onClick(View v) {    
	             ...
	             wifiManager=(WifiManager)MoreWifiSettingPage.this.getSystemService(Context.WIFI_SERVICE);              
	             System.out.println("wifi state --->"+wifiManager.getWifiState());    
	             //Toast.makeText(MoreWifiSettingPage.this, "当前网卡状态为："+wifiManager.getWifiState(),Toast.LENGTH_SHORT).show();
	             if (wifiManager.getWifiState() == 0) {
	            	 Toast.makeText(MoreWifiSettingPage.this, "当前WiFi状态为：正在关闭",
	            			 Toast.LENGTH_SHORT).show();} 
	             else if (wifiManager.getWifiState() == 1){
	            	 Toast.makeText(MoreWifiSettingPage.this, "当前WiFi状态为：不可用",Toast.LENGTH_SHORT).show();}
	             else if (wifiManager.getWifiState() == 2){
	            	 Toast.makeText(MoreWifiSettingPage.this, "当前WiFi状态为：正在打开",Toast.LENGTH_SHORT).show();}
	             else if (wifiManager.getWifiState() == 3){
	            	 Toast.makeText(MoreWifiSettingPage.this, "当前WiFi状态为：可用",Toast.LENGTH_SHORT).show();}
	             else {
	            	 Toast.makeText(MoreWifiSettingPage.this, "当前WiFi状态为：正处于未知状态",Toast.LENGTH_SHORT).show();}
	             }
	         }  
