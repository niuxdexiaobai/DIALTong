...
import com.zhy.dialtong.fragment.MoreFragment;
...
public class HomeTabHostAcitivity extends TabActivity{
	...
	private void init() {
		setIndicator("拨号", 0, new Intent(this, DialFragment.class), R.drawable.tab_dial_selected);
		setIndicator("ͨ通话记录", 1, new Intent(this, RecentCallFragment.class), R.drawable.tab_sms_normal);
		setIndicator("联系人", 2, new Intent(this, ContactsTabHostActivity.class), R.drawable.tab_contact_normal);
		setIndicator("更多", 3, new Intent(this, MoreFragment.class), R.drawable.tab_settings_normal);
